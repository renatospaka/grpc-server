...
func (x *CourseResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CourseResult) ProtoMessage() {}

func (x *CourseResult) ProtoReflect() protoreflect.Message {
	mi := &file_course_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CourseResult.ProtoReflect.Descriptor instead.
func (*CourseResult) Descriptor() ([]byte, []int) {
	return file_course_proto_rawDescGZIP(), []int{1}
}

func (x *CourseResult) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CourseResult) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_course_proto_rawDesc = []byte{
	,
...
var file_course_proto_goTypes = []interface{}{
	(*Course)(nil),       // 0: Course
	(*CourseResult)(nil), // 1: CourseResult
}
var file_course_proto_depIdxs = []int32{
	0, // 0: CourseService.CreateCourse:input_type -> Course
	1, // 1: CourseService.CreateCourse:output_type -> CourseResult
